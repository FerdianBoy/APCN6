...
varr =
`Hallo ${pushname} I'M Zero YT7 have a nice day`
lett =
`𝐁𝐨𝐭 𝐈𝐧𝐟𝐨
Creator : AGIL
Prefix : Multi Prefix
...
zeroyt7.sendMessage(`6289635188787@s.whatsapp.net`, options, text, { quoted: ftrol })
...
zeroyt7.sendMessage(from, buffer, image, {quoted: ftrol, caption: '*©Creator : Ferdian Boy*'})
break
case 'phkomen':
...
zeroyt7.sendMessage(from, gambar, image, { quoted: ftrol, caption: '*©Creator : Ferdian Boy*' })
})
break
